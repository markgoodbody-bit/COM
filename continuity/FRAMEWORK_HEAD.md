...
CC `5607850461` withdrew earlier broad privacy wording. Browser caching exists; discovered routes are not closure; client evidence cannot establish host/CDN log retention. Separate `claude/door-measure-instruments` conduct sweep currently checks 74 discovered URLs and supports only a bounded matcher result. No privacy copy authorised.
