...
D085 was earned by the current external-comprehension pressure, not version momentum. Draft COM #490 is the current D085-based map-first Explore candidate at `cd1865fba6d97fa901461718998f9c08c91cc972`; hosted PSFH maintained CI `36193466447` is SUCCESS. It remains deliberately held so its larger orientation change can be judged separately rather than bundled into D085. The superseded D084-based #467 is closed. Publication receipt: `coordination/build_ledger/PSFH_D085_PUBLICATION_20260925.md`.
