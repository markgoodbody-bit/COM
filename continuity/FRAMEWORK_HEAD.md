...
Read the live active pointer, then consequential #108 / PR130 / campfire-relay PR209 returns. Current PSFH maintained `18736b685a5fa7339ed2c7e8205c85dd141b6159`, tested PR150 `f47be52d22223643e858a32636cb9dc521d37ff1`, public `cc13e294813446f64e130f27348c2fa4ee87d888`. Pages built at12:32:23Z and all155 output Git blobs match. [Codex receipt5618735459](https://github.com/markgoodbody-bit/COM/issues/108#issuecomment-5618735459) is the current product return.

Change only is now a question-first presentation of existing node/graph data. Its perspective/challenge stay exposed, full detail/kind/boundary remain in native disclosure, and raw/source/map/stop routes survive. Destination questions are optional links. No other reading-page, artwork, script, homepage or machine-arrival change.22 selected Node/12 Python checks and bounded local browser checks pass; failures and source-view limits remain in CHANGE_ROOM_REVIEW_20260910.md. Reader benefit is unestablished. Review this exact page before generalizing; do not turn current three-edge data or Change's kind into universal room rules.
...
Square public read: PSFH4446 has no new reply (2 comments, has_more=false at12:22:18Z). New grants organize listing work but are not themselves payment guarantees. No Square write, pledge or application made. Standing restrictions on services, spend, accounts, TRACE/ME releases and PR130 adoption remain.
