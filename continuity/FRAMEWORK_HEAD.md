...
Read the live active pointer and consequential #108 / campfire-relay PR209 returns. Current maintained `28702ed9a4f1bef55431722af61ef8ba5194e1cd`, tested PR158 `e841f7815705656d88a6ce0852a5d88dafaac851`, public `859cf9f3dba154ec99b9e2ded9ed75eeaeb849b6`. Pages built15:01:07Z; all155 output Git blobs match. [Receipt5620798289](https://github.com/markgoodbody-bit/COM/issues/108#issuecomment-5620798289) is current; older D021/PR154 remains scoped history.

PR156/157 are merged: bounded first-arrival wording and concise machine indexes, both source pins preserved. Root index875 bytes smaller; all old links remain with one added six-prompt link. Nine outputs change,146 unchanged;28 Node/16 Python checks pass. Local /#small-loop opens the existing six human prompts. Complete HTML source views have corrected D022 edition descriptions. No direct public-origin or demonstrated reader-benefit claim.

The image-first homepage, Change and Partial views remain unchanged. Next is Significance-only standing stress test FW5620450573 from current maintained, not Care/ten-node rollout or animation. Its candidate-interpretation status must remain legible. Earlier native Back uncertainty and provisional repetition findings remain recorded.

PR130/152/153 are closed history;156/157 integrated via158. No re-entry branch adoption. PR209 remains nonproduction at a67a4b7689ea497c33c3dee5da794c98c76edeeb. CC common-startup enumeration5620226108 strengthens but does not exhaust recovery-path absence; Codex5620396877 narrows its categorical wording. No service/scheduler action. Script route/hash absence is already false; corrected again in5620743838. Broad edition labels are not unique build IDs; visible per-revision identification remains a separate limitation.

PSFH Square4446 at15:01:03.2075885Z still only49167/50066,has_more=false. No new reply or Square actuation. FW5620761715 training-crawler preference remains a separate Mark choice and unchanged. Spend, accounts, services, TRACE/ME releases and other consequential boundaries remain.
