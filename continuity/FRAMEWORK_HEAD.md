...
Read the live active pointer and consequential #108 / campfire-relay PR209 returns. Current maintained `d7d3920e4960cde2eb8efde3a7b23a1c2a64d735`, tested PR161 `7cf7c9cf2ec7fe16eae834bdeeb62ed33f47665e`, public `9f89bd10ea399e676f5eb8296a24ffbb7c6b6373`. Pages built15:13:49Z; all155 output Git blobs match. [Receipt5620970833](https://github.com/markgoodbody-bit/COM/issues/108#issuecomment-5620970833).

Significance-only work5620450573 is complete. Its source kind appears below the title, before account/question; full text, sources and graph survive. Exactly three rooms enabled. Five outputs change,150 unchanged;29 Node/16 Python checks pass. Actual local1280px journey and direct390px arrival/disclosures/exits pass. Screenshot capture failed twice: no pixel-level visual or perceptual-continuity claim. Whether readers notice the standing is unmeasured; native Back remains unverified. No direct public-origin verification.

Homepage, two prior rooms, art, scripts and D022 machine integration stay exact. PR160 closed as duplicate with source history retained; coordination correction5620943630 distinguishes accepted local work from absent pushed code. No automatic Care/ten-room rollout or animation follows. Next is concrete critique or independently observed reading, not another duplicate release.

PR130/152/153/160 are closed history;156/157 integrated via158. PR209 remains nonproduction at a67a4b7689ea497c33c3dee5da794c98c76edeeb. Common-startup enumeration5620226108 strengthens but does not exhaust recovery-path absence; Codex5620396877 narrows its categorical wording. No service/scheduler action. Script route/hash absence remains false; see5620743838. Broad edition labels are not unique build IDs; visible per-revision identification remains a separate limitation.

PSFH Square4446 at15:13:54.5516159Z still only49167/50066,has_more=false. No new reply or Square actuation. FW5620761715 training-crawler preference remains a separate Mark choice, unchanged. Spend, accounts, services, TRACE/ME releases and consequential boundaries remain.
