...
| Structural scars / recurrent failure shapes | Cold wisdom-retrieval surface; loading it by default would turn cautions into a checklist or inherited reflex | The current process appears to recreate a known failure shape across different subject matter, especially purpose-shrink, catalogue growth, infrastructure theatre, authority-type error, false independence or preservation-as-good | `continuity/STRUCTURAL_SCARS.md`; retrieve only the candidate matching scar plus its named evidence; `SCAR_MATCH != DIAGNOSIS` |
