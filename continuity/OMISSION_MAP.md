...
| TRACE / ME successor pressure | A question asks what a future TRACE/ME version should change, or a new field case appears to force baseline expansion | `coordination/ME_TRACE_SUCCESSOR_PRESSURE_LEDGER_20260919.md` first. It separates real patch pressure from survived/no-patch evidence and implementation-only repairs. Do not start successor text merely because the ledger exists. |
