...
INPUT_SHA = '0d0a7d53957bbd1b59b55231f18df01a95735d309ecbc19d96eec6a73f6f3861'
...
def assemble(root, output, previous=None):
    ...
    inventory = {'format': 'psfh-resource-copies/0.2', 'input_sha256': INPUT_SHA,
                 ...
                 'boundary': 'Pinned project-controlled reading copies, not a whole ecosystem mirror or validation result. Current aliases carry the released TRACE v0.4.0 and Mechanical Ethics v0.8.0 documents plus owner-issued training permission notices whose grants remain explicitly scoped to TRACE v0.3.0 and Mechanical Ethics v0.7.0. Snapshot paths preserve immutable release identities and must not be overwritten. Crawler access remains separate from training permission; third-party rights remain outside the grants.',
                 'projects': projects}
    title = 'Read TRACE and Mechanical Ethics'
    intro = 'The documents are here on this site as exact local copies of the current released TRACE v0.4.0 compact baseline and Mechanical Ethics v0.8.0 reader. Release changes status, not validation or demonstrated practical advantage. Earlier published editions remain at fixed snapshot paths.'
    limit = 'GitHub remains the place for source history, criticism and discussion. FPF and other third-party references remain elsewhere. This is not a self-contained copy of every linked source. The included AI_TRAINING_PERMISSION.md notices remain scoped to owner-controlled TRACE v0.3.0 and Mechanical Ethics v0.7.0 material; they do not automatically extend to the current v0.4.0 / v0.8.0 releases, third-party material, or create a general reuse licence.'
    text = '# ' + title + '\n\n' + intro + '\n\n' + limit + '\n'
