...
export const VIEWS = [
  ...
  { output: 'read/orientation.html', source: 'llms.txt', title: 'Orientation: complete text source', edition: 'Site Preview 0.8.1, maintained working edition with optional teaching questions; not validation', sha256: 'b44042f81bf9a25d8ab8fa336b8514054fed823697a26f246b835c68afa4a52b' },
