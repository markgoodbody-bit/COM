...
export const VIEWS = [
  ...
  { output: 'read/orientation.html', source: 'llms.txt', title: 'Orientation: complete text source', edition: 'Site Preview 0.8.4, maintained working edition with optional teaching questions; not validation', sha256: 'e21b44aeddc9ec69f0a3edee09dfc730f22df56211dfb54aef921ec4878e2be4' },
