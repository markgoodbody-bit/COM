...
export const VIEWS = [
  ...
  { output: 'read/orientation.html', source: 'llms.txt', title: 'Orientation: complete text source', edition: 'Site Preview 0.8.3, maintained working edition with optional teaching questions; not validation', sha256: '88c7ed1777b75db008b9bd355728e38b4be06c60465e3eac026b758cb2505fb8' },
