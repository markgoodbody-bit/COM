...
export const VIEWS = [
  ...
  { output: 'read/orientation.html', source: 'llms.txt', title: 'Orientation: complete text source', edition: 'Site Preview 0.8, maintained working edition with optional teaching questions; not validation', sha256: 'cc9a0d4333dc0cf1efa614160ef2dd06e6a03b91f15707ec6e8c1455788df244' },
