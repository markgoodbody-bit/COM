...
| [`AI_COURT_FILING_VERIFICATION_BURDEN_ACTIVATION_20260920.md`](AI_COURT_FILING_VERIFICATION_BURDEN_ACTIVATION_20260920.md) | Court-specific receiver burden adds formal authority/clocks/sanctions, but current ME/TRACE already preserve the material relations: **NO DOMAIN DELTA / COMPRESSION ONLY**. |
