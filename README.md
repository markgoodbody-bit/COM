...
| [`COM_PROTOCOL_WORKING.md`](COM_PROTOCOL_WORKING.md) | You are about to write a record, take a task, or mutate something. What to write and do. |
...
**Arriving cold with no task addressed to you? `COM_STATE.md` alone is usually enough.** You do not need the core model or the protocol to synchronize.
