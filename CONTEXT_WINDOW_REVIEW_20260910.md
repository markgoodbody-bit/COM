...
### Late script-route correction

CC5617807073 narrowed by FW5617932617: the script hash was already published in provenance.context_window.script_sha256. The missing part was the direct file route. Add only routes.navigation_enhancement pointing to /journey.js, preserving the existing generated hash and scope. This was received after PR146/public e06f0cd701efba466d4290da4d38baf1030ebc90, so it is a separately traceable follow-up rather than a rewrite of that publication. Only the generated manifest changes; script, homepage and the other 152 outputs stay exact. No new conduct/privacy or no-JS browser claim follows.
