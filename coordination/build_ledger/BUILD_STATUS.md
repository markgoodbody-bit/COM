...
- proposal hard-limit: 1,500 words; current exact proposal-body count after the 26 September owner-test repair is **1,362 whitespace-delimited words / 1,405 word-like tokens**; both local methods remain below the ceiling and final editor recount is still required;
