...
- proposal hard-limit: 1,500 words; current exact proposal-body count after the 26 September owner-test repair is **1,331 whitespace-delimited words / 1,369 word-like tokens**; both local methods remain below the ceiling and final editor recount is still required;
