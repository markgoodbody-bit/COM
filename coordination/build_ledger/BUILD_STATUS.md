...
| --- | --- | --- |
| Please Start From Here D062 | **LIVE / PUBLISHED** | Site Preview 0.8.21. Maintained `5f35e578ef4510cb0e499dadb5971f7ed45c25e6`; public `fcd264aed8d73cf0ed17272300b27b66cb16760c`. Codex receipt `5649519801`: 156 generated files matched HTTPS hashes; not independent review or browser interaction. |
| Please Start From Here D063 | **SEMANTIC CANDIDATE / PUBLICATION HANDOFF ACTIVE** | PR #289, semantic head `1dd93c65094f9735d955dc61400b0f500fd9de3d`, exact D062 base `5f35e578...`. Three compact entrance files only: `affected parties` -> `who or what may be affected`; seed 0.5 removes generic `sender` assumption and remains exactly 1023 bytes. Codex handoff COM #108 `5649616301`. Not public until maintained/public/HTTPS receipt exists. |
...
| Open Horizon | **ROUTING COMPLETE / HORIZON OPEN** | Human + machine discoverability exists for all 18 current territories. `open-horizon/map.json` is routing metadata, not canon/theory/work queue. |
...
| Claude Code bounded cold read | **REQUESTED / OPTIONAL** | COM #108 comment `5649592499`: current public URL cold, one consequential defect or `NO_DELTA`, no score/benchmark/efficacy claim. Reverify availability; no reply is not a blocker. |
...
D063 is earned as one coherent bundle because the same narrower `affected parties` category remained across seed, text orientation and JSON entrance while the visible site/TRACE already used broader affected scope. The broader wording does not settle standing or widen authority.
...
- COM `main`: reacquire before operational use; latest known mutation from this aperture includes pointer/ledger refresh after D063 creation.
- PSFH maintained live: `5f35e578ef4510cb0e499dadb5971f7ed45c25e6` until D063 publishes.
- PSFH public live: `fcd264aed8d73cf0ed17272300b27b66cb16760c` until D063 publishes.
- D063 semantic head: `1dd93c65094f9735d955dc61400b0f500fd9de3d`.
