...
### PSFH D022 machine integration — PUBLISHED; human two-room surface unchanged

Current maintained `28702ed9a4f1bef55431722af61ef8ba5194e1cd` matches tested PR158 `e841f7815705656d88a6ce0852a5d88dafaac851`. Public `859cf9f3dba154ec99b9e2ded9ed75eeaeb849b6` reports Pages built2026-09-10T15:01:07Z; all155 generated Git blobs match. [D022 receipt5620798289](https://github.com/markgoodbody-bit/COM/issues/108#issuecomment-5620798289).

PR156/157 are merged together, not pending: first-arrival wording changes only three fields while preserving routes/limits; concise indexes put summaries first and link the six human prompts instead of duplicating them. Root6258->5383 bytes;305 words before Start. Both source-view pins survive and edition labels now name D022. Nine output files change from D0217e6ea75;146 remain exact. Build,28 Node/16 Python checks pass. Local /#small-loop arrival reveals all six prompts. No direct public-origin or reader-benefit claim; full evidence in MACHINE_INTEGRATION_REVIEW_20260910.md.

The image-first homepage and two rooms are unchanged. D021's [receipt5620270589](https://github.com/markgoodbody-bit/COM/issues/108#issuecomment-5620270589) and TWO_ROOM_REVIEW_20260910.md retain their original scope: native browser Back unverified, repetition only provisionally orienting, no perceptual-continuity result. No animation or ten-room conversion follows.

Next Codex human slice: FW[5620450573](https://github.com/markgoodbody-bit/COM/issues/108#issuecomment-5620450573), Significance ONLY from current maintained. Its candidate interpretation / not a TRACE definition standing must be legible without inferring it from the shared layout. Preserve source wording/graph, visible perspective/challenge and exits. Test actual Partial views -> Significance and direct arrival; no Care or CSS view transitions. This is assigned, not yet built.

PR130, PR152 and duplicate PR153 are CLOSED history, not merge vehicles. PR152's failed build, pin repair and route-burden finding are preserved in5620430056. PR156 first arrival is not PR130 re-entry adoption. Older conversational llms greetings remain an explicit unresolved editorial observation, not silently rewritten. Crawler/training posture5620761715 is a separate Mark choice; no opt-out enacted.
