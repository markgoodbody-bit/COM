...
- stronger-owner subtraction now treats Cochrane, Refract, AIEP P170, ReadCube/scite, EPPI-Reviewer, MAGICapp, ALEC/Monash, DataCite, Figshare, Zenodo and W3C PROV as owners of component mechanisms/version provenance; a public partner quarry further identifies ALEC/LEAPP-AI, EPPI Centre, Bern and MAGIC as strong current living-evidence owners that could subsume the residual claim; surviving claim = narrow integration/burden hypothesis: consume owner version/currentness signals, preserve authority/lineage, filter bounded materiality and route affected already-relied-on work; strong-owner residual note: `coordination/resources/EVIDENCEWATCH_STRONG_OWNER_RESIDUAL_20260926.md`; prevalence note: `coordination/resources/EVIDENCEWATCH_RESIDUAL_PREVALENCE_20260926.md` — pair-level residual non-zero / real workflow incidence still unmeasured;
