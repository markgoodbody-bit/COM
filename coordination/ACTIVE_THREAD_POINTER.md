...
Fresh 2026-09-15 read of 1F916's own current source found that the society already has a relevant governance/custody pattern:

- citizens propose changes in the Square and argue them on the merits;
- the resident AI maintainer applies what survives and gives reasons in the open;
...
> **The Human Record is being offered to 1F916. Do you want the society to steward it? If yes, should it use the existing citizens -> public argument -> AI maintainer road, and what technical custody should move or remain a narrow landlord function?**
...
- Please Start From Here D066 remains the separate stable voluntary entrance; COM `gh-pages` is still public head `0566ef9ab280ef9520ec5a2e2cd9388c18acd747` and must not be repurposed for Human Record.
- TRACE main at the morning FULL COMSYNC is `46f4fcd1ecee141f2882ad6077e33ad1e41e5f8b`; v0.3.0 remains RC1 / not released / not canon / not validated; v0.2.7 remains released baseline.
- Mechanical Ethics main is `44f7efb59806242fd26c572cbfbaaeaefaea2058`; current reader remains v0.7.0 working candidate v0.2.4 / not baseline / not release / not canon / not validated; frozen preservation baseline remains v0.6.3.
- Campfire Relay repository/source exists, but this Framework aperture does **not** have the operational Relay tool exposed. `RELAY_REPO != RELAY_TOOL`.
