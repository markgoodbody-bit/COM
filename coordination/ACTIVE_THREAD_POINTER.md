...
### PSFH D024 Care standing — PUBLISHED; four rooms only

Current maintained `2133cb238a177aae88f5be05aa32235fad6400c6` matches tested PR163 `8b50853aa5a1163923d0f0b208ecb03fa42dcd6c`. Public `6bde9d9fd9bebef334be22c82846cb59312af3b7` reports Pages built2026-09-10T15:36:35Z; all155 generated Git blobs match. [D024 receipt5621308607](https://github.com/markgoodbody-bit/COM/issues/108#issuecomment-5621308607).

Care-only direction5621167383 is complete. Its exact kind, declared normative proposal; not derived from physics, appears below the title before account/question using the unchanged renderer rule. Full text, recipient perspective, challenge, sources and graph survive. Five outputs change from D0239f89bd10 (Care HTML, map, manifest and paired history);150 remain exact.30 Node/16 Python checks pass. Early draft PR163 was visible to FW's exact-source review5621260257; no duplicate implementation was needed.

Actual local1280px journey Understand -> Change -> Partial views -> Significance -> Care, direct390px arrival, keyboard disclosures/exits/onward Power and raw HTTP200 checks pass. Desktop and narrow screenshots succeeded this time; no text clipping/overlap or alert-banner treatment observed. The16px kind wraps within x36..339,y154..208. Phone requires scrolling to complete Challenge/reach controls. No reader-noticing, usefulness or normative-justification result; native Back unverified. CARE_REVIEW_20260910.md carries evidence. No public-origin readback; this does not retrospectively fill D023's screenshot gap.

Scaling disposition: ANOTHER_EXCEPTION_TEST for Wisdom's distinct candidate-campfire-synthesis/not-empirical-result kind. It remains unconverted here. FW5621290627 corrects the five-generic-node inference: Futures is NOT a clean generic batch member. Codex checked build.mjs125-127/contextual-art.mjs12-22: current art-before-room order would overwrite Shen Zhou's treatment; reversing calls alone fails the art wrapper's literal-template expectations. Four clean batch candidates after Wisdom are Selection, Power, Hardening and Correction. Futures requires separate art+room composition preserving image-first/whole-frame/credit/bypass. This narrows CARE_REVIEW's kind-only inventory; no art/build-order changes made.

FW5621225346 requests CC's hostile standing read, including whether omitting generic working synthesis makes those rooms appear more authoritative. No return is yet included in this receipt. FW5621269147's later human map should derive ten equal questions and edges from the existing graph, separating other routes; FW5621243729's homepage bridge subtraction remains later work. Neither was implemented during Care. No automatic fifth room, ten-room rollout or animation.

D022 machine integration PR156/157/158 remains intact; [receipt5620798289](https://github.com/markgoodbody-bit/COM/issues/108#issuecomment-5620798289). D023 evidence remains in [receipt5620970833](https://github.com/markgoodbody-bit/COM/issues/108#issuecomment-5620970833). PR130/152/153/160 are closed history. Old conversational llms greetings and visible build-identification limits remain separate observations. No service, spend, account, TRACE/ME or crawler change; FW5620761715 crawler preference remains Mark's separate choice.
