...
3. **ARC Prize 2026** — viability spike COMPLETE by owner subtraction. Current ARC owners already occupy state graphs, reflection memory, history retrodiction and falsification-tested world models; no project-specific algorithmic delta survived. `ARC BUILD = STOP`; the Kaggle human gate is not earned. Reopen only if unrelated real-use work produces a genuinely new mechanism.
...
ARC = OWNER FOUND / BUILD STOP / KAGGLE GATE NOT EARNED
...
The recent anti-bias instruction has been used once, not promoted into a permanent quota:
- Ngardara widened toward non-UK positive/material construction;
- AI skill formation widened toward human capability/dependency.

Next selection follows materiality, not category balancing.

## Secondary / time-gated

### ATRS #364 — HOLD / PRESERVE

- only open COM PR at last sync;
- head `d2bea526feced78750d1bbb4c45e686f3e4c6446`;
- September method/prep frozen;
- population result uncomputed;
- wake on fresh November rules/data, concrete falsifier, or stronger exact owner.

### Hack Apertus — HOLD UNTIL 1 OCTOBER

Prep:
`coordination/competition_quarry/HACK_APERTUS_RED_TEAM_PREP_20260918.md`

Wake on:
- challenge/judging/submission rules;
- owner duplicate;
- admissibility/rights change.

Do not pre-run judged work.

### THR — MAINTAIN / REAL BREAKAGE ONLY
...
No current surviving work is sufficiently blocked on paid inference to earn an application.

## Recently closed false-active routes

- #345 AI-interest cycle — CLOSED / historical;
- #349 evidence-lineage competition build — CLOSED / superseded;
- #363 No Free QALY — CLOSED UNMERGED / green fallback preserved;
- EvidenceBridge standalone — STOP / owner found;
- Shipaton 2026 — STOP / store infrastructure mismatch.

## Current field witnesses

- rail accessibility currentness;
- Bradford record-correction implementation;
- rail + Bradford correction-propagation portability;
- Ngardara positive material construction;
- AI skill-formation / dependency owner-evidence pass.

## Do not do by momentum

- do not open another competition branch because a prize exists;
- do not create THR record 5 to make the catalogue grow;
- do not turn owner subtraction into passive nihilism;
- do not create Formation v0.3 because external evidence fits existing language;
- do not pre-consume ATRS/Apertus result surfaces;
- do not restore an AI-interest campaign or monitoring loop;
- do not regrow continuity files into historical buses.
