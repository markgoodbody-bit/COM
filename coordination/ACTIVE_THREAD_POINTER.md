...
### PSFH Change and Partial views — PUBLISHED; two rooms only

Current maintained `4bf08436a917ab2c31881a035fa223fc57bbfb6b` matches tested PR154 `1df769af1d7f3fc04c43c66b47b5a387fbf865f4`. Public `7e6ea75c8040feb891dd725a5acad6bcaef9eb82` is confirmed built by GitHub Pages at 2026-09-10T14:24:56Z; all 155 generated Git blobs match. Receipt: [5620270589](https://github.com/markgoodbody-bit/COM/issues/108#issuecomment-5620270589). Previous one-room publication `cc13e294813446f64e130f27348c2fa4ee87d888` and its [receipt5618735459](https://github.com/markgoodbody-bit/COM/issues/108#issuecomment-5618735459) remain history, not competing current state.

Exactly Change and Aperture (Partial views) now use the same question-first renderer, derived from unchanged node/index/target data. Another position and Challenge stay visible; full detail, kind/boundary and sources survive in native disclosures and raw representations. Change says Understand route, correcting the misleading static Back label; Aperture invents no history or reverse edge. Six outputs change from cc13e294: two room HTML files, delivery map, manifest and paired D021 history; 149 remain exact. Manifest updated now denotes deliberate material revision and is checked against dated history, not a build clock or linked-source freshness. No artwork, homepage, shared CSS, script or machine-arrival change.

Checks: build, 25 Node and 12 Python passes; original-paragraph/source preservation, graph/missing-field counterexamples, exact delivery hashes. TWO_ROOM_REVIEW_20260910.md records actual local Understand -> Change -> Partial views navigation, 1077/390/320px inspection, keyboard disclosures, map/stop/onward routes and raw Aperture HTTP200. Native browser Back is unverified; the automation shortcut did not navigate. No direct public-origin verification or reader-benefit result. CC5620110569's served-byte check covers preceding D020 only, not this publication.

Next useful action is exact-version critique: does the presentation help or add ceremony? The repeated destination question appears orienting to Codex; homepage-to-Change repeats more material and presents a stronger duplication risk. This is provisional, not measured continuity or a reason to add animation. Different node kinds cannot inherit these generic-synthesis rooms' hierarchy automatically. No ten-node conversion or new artwork follows. PR153 is an overlapping source-only probe; consolidation requested in5620245293, not published separately. PR152 remains a separate source-only llms formatting candidate at231f4f9dc166dd92a8b76391388ce17ae702c077; its manifest date-only overlap is addressed here. Crawler/training posture from FW5619114228 remains a separate Mark choice, not changed.
