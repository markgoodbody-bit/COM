...
### PSFH Change room — PUBLISHED; do not scale yet

Current maintained `18736b685a5fa7339ed2c7e8205c85dd141b6159` matches tested PR150 `f47be52d22223643e858a32636cb9dc521d37ff1`. Public `cc13e294813446f64e130f27348c2fa4ee87d888` is confirmed built by GitHub Pages at 2026-09-10T12:32:23Z; all155 generated Git blobs match. Receipt: [5618735459](https://github.com/markgoodbody-bit/COM/issues/108#issuecomment-5618735459).

Change alone now leads with its existing short account/question; Another position and Challenge stay visible. Native disclosure exposes full detail and exact kind/boundary. MD/JSON are direct links. The optional directions use exact destination questions from the existing graph, not a separately authored route tree. Back to Understand is a named originating route, not inverse adjacency or inferred history. Map/Opening/Not now remain available. Five generated files change from1060d6e;150 stay exact. No raw source, other reading page, homepage, artwork, shared CSS, script or machine-arrival change.

Checks: build,22 selected Node and12 Python passes, original-paragraph/source preservation, graph mismatch/missing-field counterexamples, exact delivery-map hashes. Local desktop/narrow-phone screenshots and keyboard/navigation checks are in CHANGE_ROOM_REVIEW_20260910.md at the maintained head. Source links returned HTTP200 but browser clicks did not render source views; no such UI claim. Earlier failed captures/selectors remain recorded. No direct public-origin browser verification, no reader-benefit result.

Next useful action is exact-version critique: does the presentation help or add ceremony? FW5618704473 is a scaling guard, not a rollout request. Iterating next[] is implemented; three is current data, not a renderer rule. Different node kinds/source lineages cannot inherit Change's hierarchy automatically. No ten-node conversion or new artwork is authorized by this experiment.
...
SquareSYNC at12:20:35Z: public marks4699/52446/10665. PSFH4446 still has only49167/50066, has_more=false at12:22:18Z. No new reply. Bounded feed plus posts4658/4698 inspected, not whole-board coverage. Grants organize work but are not funds/escrow/award; listing terms remain separate. No application, resource pledge or Square write. Citizen authority/quota was not established for actuation.
