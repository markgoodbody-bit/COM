...
### PSFH D027 Futures art + room — PUBLISHED; ten readings complete

Maintained `146d9d47a8136578c768b4005f997c16aad12d46` matches tested PR170 `a3a4df294fc058fad0096a1fd65181e2fbfbebce`. Public `89dbc4dbafb64b8af92edaed203a2a59d6311920` reports Pages built2026-09-10T17:21:58Z,error null; all155 generated Git blobs match. [D027 receipt5622689697](https://github.com/markgoodbody-bit/COM/issues/108#issuecomment-5622689697).

Futures composition direction5622519905 complete. Stage-A control35f9c412283fc3bc74c65ab9cbec9cbe99e88bd8 ran wrapper/order changes with Futures disabled:155 exact D026 outputs. Stage B composes unchanged artwork section before full reading; all original account/source/graph content survives, one figure/reading/question ID, no duplicate IDs. Five outputs change from37e3a92d (Futures HTML,map,manifest,paired history);150 exact, including prior nine rooms, Explore/Atkins, homepage,machine,CSS/script/art bytes.35 Node/16 Python checks pass.

Actual local homepage Work/Future route plus Power/Hardening entries checked. Desktop and390px art/reading screenshots inspected without clipping/overflow; image loaded whole-frame with contain. Browser found art bypass scrolled without focus; Futures main tabindex=-1 now receives focus, question skip focuses H2, Tab continues to account summary. Both skip purposes remain distinct. Disclosures, Map/Not now, canonical Works and onward Power checked. Raw MD/JSON200. Report FUTURES_COMPOSITION_REVIEW_20260910.md records the correction and narrower phone reading panel. No native-Back, reader-benefit/comprehension, curatorial validation or public-origin readback claim.

Next is the prepared graph-derived human map5621269147/5622354762, then separately bridge subtraction5621243729. Ten-node room treatment is complete; no further room machinery. Wrapper is controlled-template code, not a general HTML parser; FW5622580272's hypothetical existing-class duplication remains outside current inputs.

CC5622566796 reports control-backed clean internal human/machine link sweeps; third-party links excluded, no instrument/per-file identities provided. Preserve reported bounded result, not Codex origin/final-D027/universal evidence. CC5622481472 script-identity closure remains; root-llms summary limit note stays separate. Prior standing-presence/prominence and unfamiliar terminology questions remain unresolved.

Square4446 at17:21:55.3221154Z still49167/50066,has_more=false; no reply/write. PR209 since17:03Z no new comments. No service/scheduler/account/spend/TRACE/ME/licence/crawler mutation. Prior D026 receipt5622519995 and earlier receipts preserve history.
