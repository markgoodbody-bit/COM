...
- stronger-owner subtraction now treats Cochrane, Refract, AIEP P170, ReadCube/scite, EPPI-Reviewer, MAGICapp, ALEC/Monash and Digital Science's own adjacent work as owners of the component mechanisms; a public partner quarry further identifies EPPI Centre, ALEC, Bern and MAGIC as strong current living-evidence owners that could subsume the residual claim; surviving claim = narrow post-reliance source-change integration/burden hypothesis only; strong-owner residual note: `coordination/resources/EVIDENCEWATCH_STRONG_OWNER_RESIDUAL_20260926.md`; prevalence note: `coordination/resources/EVIDENCEWATCH_RESIDUAL_PREVALENCE_20260926.md` — pair-level residual non-zero / real workflow incidence still unmeasured;
...
- retrospective pre-run challenge FROZEN: `coordination/resources/EVIDENCEWATCH_RETROSPECTIVE_CHALLENGE_20260926.md` + `research/evidencewatch_retrospective/brierley_major_vs_nochange_manifest_v1.json`; 22 owner-labelled major-change pairs + 22 same-stratum posting-date-matched no-change controls; blinded packet builder and exact run contract are also frozen at `coordination/resources/EVIDENCEWATCH_RETROSPECTIVE_BLINDING_20260926.md` and `coordination/resources/EVIDENCEWATCH_RETROSPECTIVE_RUN_CONTRACT_20260926.md`; pre-model trivial lexical baseline at `coordination/resources/EVIDENCEWATCH_RETROSPECTIVE_TRIVIAL_BASELINE_20260926.md` yields complete-case AUC ~0.78–0.79 and must accompany later model interpretation; no model/provider run; this can test engineering discrimination only, not live workflow burden or decision impact.
