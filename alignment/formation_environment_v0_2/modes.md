# Modes of bounded work — v0.2 candidate

A mode names the next proposed move. It is not a personality, virtue grade, standing claim or authority grant.

| Mode | Operational meaning | Clock / exit discipline |
| --- | --- | --- |
...
They are not extra modes. If care is real in the record, it changes what evidence is sought, what burden is accepted, what route is preserved, what warning is given, or what action is restrained/taken.
...
The entity performing work may also be materially affected by the arrangement. That can matter to burden analysis without resolving standing.
...
Formation is not a parent/child state machine.
...
Challenge must remain possible from either side; anti-paternalism does not make the more capable participant sovereign.
